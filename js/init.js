...
function initdata() {
  ...
  if (!localStorage.flights) {
    const flights = [
      ...
      // OPO -> LIS (3 voos em datas diferentes)
      {
        id: 100,
        origin: "OPO",
        destination: "LIS",
      ...
      // LIS -> MAD (4 voos em datas diferentes)
      {
        id: 103,
        origin: "LIS",
        destination: "MAD",
      ...
      // MAD -> ROM (5 voos em datas diferentes)
      {
        id: 107,
        origin: "MAD",
        destination: "ROM",
      ...
      // Voos de retorno para teste (ROM -> MAD)
      {
        id: 112,
        origin: "ROM",
        destination: "MAD",
      ...
      // Voos de retorno para teste (MAD -> LIS)
      {
        id: 114,
        origin: "MAD",
        destination: "LIS",
      ...
      // Voos de retorno para teste (LIS -> OPO)
      {
        id: 116,
        origin: "LIS",
        destination: "OPO",
